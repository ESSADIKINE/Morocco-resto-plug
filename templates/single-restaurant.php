...
function getRenderedTitleValue(title) {
    if (!title) {
        return '';
    }
...
function addRestaurantMarkersToFullscreenMap() {
    ...
    restaurants.forEach(restaurant => {
        ...
        if (!isNaN(lat) && !isNaN(lng)) {
            const markerTitle = getRenderedTitleValue(restaurant.title);
            console.log(`Creating marker for restaurant: ${markerTitle} at [${lat}, ${lng}]`);
            ...
            const currentRestaurantId = window.currentRestaurantData && window.currentRestaurantData.id
                ? window.currentRestaurantData.id
                : null;
            const isCurrent = restaurant.id === currentRestaurantId;

            console.log(`Restaurant: ${markerTitle || 'Unknown'}, Rating: ${rating}, ReviewCount: ${reviewCount}`);
            ...
            const getCleanTitle = (title) => {
                ...
                return getRenderedTitleValue(title) || 'Restaurant';
            };
